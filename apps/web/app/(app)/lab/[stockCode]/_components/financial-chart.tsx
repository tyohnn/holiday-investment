...
// CSS vars, not hardcoded hex — global.css defines lighter tints for these
// under .dark, so the chart follows the theme instead of staying light-mode-only.
const REVENUE_COLOR = 'var(--chart-1)';
const OP_INCOME_COLOR = 'var(--chart-2)';
const OPM_COLOR = 'var(--chart-3)';
