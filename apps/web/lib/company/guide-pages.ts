  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '주주구분 현황',
        columns: 'highlight',
        rows: shareholderGroupRows('snap-hc'),
        note: '구분 간 지분율은 중복되지 않음. 열은 시점 슬롯(연간·최근)으로 비워 둔다.',
      },
      {
        kind: 'kpis',
        id: 'snap-opinion',
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        columns: 'invest',
        rows: [
          r0('ip-price', '주가(원)', undefined, [r1('ip-price-hi', '최고'), r1('ip-price-lo', '최저')]),
          r0('ip-mcap', '시가총액', undefined, [r1('ip-mcap-hi', '최고'), r1('ip-mcap-lo', '최저')]),
          r0('ip-per', 'PER', undefined, [r1('ip-per-hi', '최고'), r1('ip-per-lo', '최저')]),
          r0('ip-pbr', 'PBR', undefined, [r1('ip-pbr-hi', '최고'), r1('ip-pbr-lo', '최저')]),
        ],
