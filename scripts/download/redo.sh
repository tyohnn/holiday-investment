...
log "=== 오염본 재다운로드 시작 ==="
redo_pl "【멤버십⭐전용】"            "https://www.youtube.com/playlist?list=PLF67QBTodqAUcDMMSIFzuRvBIp6jMCpDe" 03 04 13 19
redo_pl "【멤버십⭐전용】투자 스킬업" "https://www.youtube.com/playlist?list=PLF67QBTodqAUjLK936XdzUB01Ih6ijWwm" 07 08 10 11 14
log "=== 재다운로드 완료 ==="
echo "복구된 mp4:"; for pl in "【멤버십⭐전용】" "【멤버십⭐전용】투자 스킬업"; do
